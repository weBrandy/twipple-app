  ...
  return (
    <div className="mb-4">
      ...
      <h5 className="text-2xl mb-2">
        Twipple will combine the voice of your best-performing tweets with content pillars you choose to generate.
      </h5>
...
ContentPillars.propTypes = {
  ...
  handlePillarsChange: PropTypes.func.isRequired,
};
