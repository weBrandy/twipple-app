...
export default function OutputComponent({ tweet, onButtonClick }) {
  return (
    <div className="mt-4">
      ...
      <h5 className="text-2xl mb-2">Please use the below buttons to toggle hashtags and generate a new version based on whether you like the output or not.</h5>
      <h5 className="text-2xl mb-2">If you like the current output, Tweeple will suggest a NEW close match. If you don&apos;t, the app will try something completely new.</h5>
