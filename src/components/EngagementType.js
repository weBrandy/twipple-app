  ...
  return (
    <div className="mb-4">
      ...
      <h5 className="text-2xl mb-2">
        Twipple will generate tweets with the type of engagement you choose. You can select more than one.
      </h5>
...
EngagementType.propTypes = {
  engagementType: PropTypes.array.isRequired,
  handleEngagementType: PropTypes.func.isRequired,
};
